class Home {
    static async listar_dispositivos() {
        try {
            ...
            const resposta = await fetch(
                "http://localhost:3000/dispositivo/list_by_idusuario",
                {
                    headers: {
            ...
            const lista =
                document.getElementById("lista_dispositivo");
            ...
            for (const dispositivo of dispositivos) {
                ...
                btnExcluir.addEventListener(
                    ...
                    async () => {
                        ...
                        await Home.excluir_dispositivo(
                            dispositivo.chave
                        );
                ...
                btnDados.addEventListener(
                    ...
                    async () => {
                        ...
                        await Home.acessar_dados_dispositivo(
                            dispositivo.chave
                        );
                    }
                );
    ...
    static async excluir_dispositivo(chave) {
        ...
        try {
            ...
            const resposta = await fetch(
                "http://localhost:3000/dispositivo/delete",
                {
                    method: "DELETE",
