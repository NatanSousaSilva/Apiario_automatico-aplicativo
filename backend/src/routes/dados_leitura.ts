...
dados_leitura.post("/list_by_chavedispositivo", auth, Controller_Dados_Leitura.list_by_chavedispositivo);
dados_leitura.post("/find_by_chave_vez", auth, Controller_Dados_Leitura.find_by_chave_vez);
dados_leitura.post("/create", auth, Controller_Dados_Leitura.create_http);
